...
async def classify_router_intent(
    ...
    system_prompt = (
        ...
        "- plan_status_query: asks what SPECIFIC actions current plan prescribes (tomorrow/this week/next/Day N). User wants to SEE or KNOW what plan says to do.\n"
        ...
        "- general_chat: motivation, encouragement, timeline/duration questions (how long till goal), general advice, explanations.\n"
        "\n"
        "CRITICAL DISTINCTION - Plan queries vs. Timeline/motivation:\n"
        "- plan_status_query = 'What does my plan say for Day 3?' or 'Show me the plan' or 'Aaj ka plan kya hai' (asking for SPECIFIC prescribed actions)\n"
        "- general_chat = 'Kitne din lagega target achieve krne mei' or 'How long will it take' or 'Kab tak pahunchenge' (asking for TIMELINE/DURATION, not plan details)\n"
        "- general_chat = 'Motivation chahiye' or 'Explain my progress' or 'Am I doing okay' (seeking encouragement/explanation)\n"
        "Think: Is user asking WHAT TO DO (plan_status_query) or HOW LONG / WHY / AM I OKAY (general_chat)?\n"
        "Negative examples:\n"
        ...
        "- 'Kitne din lagega target weight achieve krne mei' is general_chat (timeline question), NOT plan_status_query.\n"
        "- 'How long will it take to reach my goal' is general_chat (timeline question), NOT plan_create_request.\n"
        "- 'Kab tak achieve hoga' is general_chat (asking timeline), NOT plan_status_query.\n"
        "- 'Show me the plan' or 'Aaj ka plan kya hai' IS plan_status_query (asking what plan says).\n"
        "Retry contract:\n"
